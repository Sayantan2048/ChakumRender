...
void loadObjects() {
  ...
  */
  ...
  vSphereList.push_back(Sphere(1e5,  Vec(50, 1e5, 81.6), Vec(0*.75, .75, 0*.75), 1.0, MaterialType(3.2, 0.6, NONE, Vec(0., 0., 0.))));
  vSphereList.push_back(Sphere(1e5,  Vec(50, -1e5 + 81.6, 81.6), Vec(0*.75, .75, .75), 1.0, MaterialType(3.2, 0.6, NONE, Vec(0., 0., 0.))));
  vSphereList.push_back(Sphere(16.5,  Vec(27, 16.5, 47), Vec(.999, .999, .999), 1.0, MaterialType(200.2, 0.9, NONE, Vec(0., 0., 0.))));
  vSphereList.push_back(Sphere(16.5,  Vec(73, 16.5, 78), Vec(.999, .999, .999), 1.0, MaterialType(200.2, 0.9, NONE, Vec(0., 0., 0.))));
  //Dummy
