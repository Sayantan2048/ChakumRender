...
void loadObjects() {
  ...
  */
  vSphereList.push_back(Sphere(1e5,  Vec(1e5 + 1, 40.8, 81.6), Vec(.75, .25 * 0, .25 * 0), 1.0,  MaterialType(0.15, 10000, 1, 1, GGX)));
  vSphereList.push_back(Sphere(1e5,  Vec(-1e5 + 99, 40.8, 81.6), Vec(.25 * 0, .25 * 0, .75), 1.0, MaterialType(0.15, 10000, 1, 1, GGX)));
  vSphereList.push_back(Sphere(1e5,  Vec(50, 40.8, 1e5), Vec(0*.75, .75, 0*.75), 1.0, MaterialType(0.15, 10000, 1, 1, GGX)));
  vSphereList.push_back(Sphere(1e5,  Vec(50, 1e5, 81.6), Vec(.75, .75, .75), 1.0, MaterialType(0.15, 10000, 1, 1, GGX)));
  vSphereList.push_back(Sphere(1e5,  Vec(50, -1e5 + 81.6, 81.6), Vec(0*.75, .75, .75), 1.0, MaterialType(0.15, 10000, 1, 1, GGX)));
  vSphereList.push_back(Sphere(16.5,  Vec(27, 16.5, 47), Vec(.999, .999, .999), 1.0, MaterialType(0.15, 10000, 1, 1, GGX)));
  vSphereList.push_back(Sphere(16.5,  Vec(73, 16.5, 78), Vec(.999, .999, .999), 1.0, MaterialType(0.15, 10000, 1, 1, GGX)));
  //Dummy
  ...
  //vTriangleList.push_back(Triangle(Vec(-5000, 0, 5000), Vec(5000, 0, 5000), Vec(5000, 0, -5000), Vec(0.9, 0.9, 0.9), 1.0, MaterialType(0.15, 10000, 1, 1, GGXAPPROX)));
  //vTriangleList.push_back(Triangle(Vec(-5000, 0, 5000), Vec(-5000, 0, -5000), Vec(5000, 0, -5000), Vec(0.9, 0.9, 0.9), 1.0, MaterialType(0.15, 10000, 1, 1, GGXAPPROX)));
